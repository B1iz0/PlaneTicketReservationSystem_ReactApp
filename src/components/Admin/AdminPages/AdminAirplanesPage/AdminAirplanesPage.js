...
const AdminAirplanesPage = () => {
    ...
    return(
        <div>
            <CustomDialog title='Add airplane' isOpened={isAddDialogOpened} closeDialog={closeAddDialog}/>
            <CustomDialog title='Edit' isOpened={isEditDialogOpened} closeDialog={closeEditInfoDialog}/>
            <CustomDialog title='More info' isOpened={isMoreInfoDialogOpened} closeDialog={closeMoreInfoDialog}/>
            <div>
