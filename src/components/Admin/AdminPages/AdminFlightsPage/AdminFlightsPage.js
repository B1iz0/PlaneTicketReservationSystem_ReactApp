...
const AdminFlightsPage = () => {
    ...
    const columns = [
        ...
        { field: 'fromAirportName', headerName: 'Departure airport', width: 200 },
        ...
        { 
          ...
          renderCell: (row) => {
            return (
              <IconButton onClick={() => openEditInfoDialog(row.row)} color="primary">
                <EditIcon />
              </IconButton>
            );
          },
        ...
        { 
          ...
          renderCell: (row) => {
            return (
              <IconButton color="primary" onClick={() => openMoreInfoDialog(row.id)}>
