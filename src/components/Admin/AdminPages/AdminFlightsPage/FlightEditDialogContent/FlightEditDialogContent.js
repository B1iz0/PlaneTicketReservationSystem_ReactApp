...
const FlightEditDialogContent = ({ flightForEditing }) => {
    ...
    const [ flightNumber, setFlightNumber ] = useState(flightForEditing?.flightNumber);
    ...
    const [ arrivalAirport, setArrivalAirport ] = useState(flightForEditing?.toAirportName);
        ...
        <DialogContent>
            <form>
                <Grid container direction="column" spacing={1}>
                    <Grid item>
                        <TextField required label="Flight number" value={flightNumber} onChange={(event) => setFlightNumber(event.target.value)}/>
                    </Grid>
                    <Grid item>
                        <FormControl>
                            ...
                            >
                                ...
                                {freeAirplanes.map((airplane) => (
                                    <MenuItem key={airplane.id} id={airplane.id} value={airplane.model}>
                                        {airplane.model}
                                    </MenuItem>
                                ))}
                            </Select>
                        ...
                        <FormControl>
                            ...
                            >
                                ...
                                {airports.map((airport) => (
                                    <MenuItem key={airport.id} id={airport.id} value={airport.name}>
                                        {airport.name}
                                    </MenuItem>
                                ))}
                            </Select>
