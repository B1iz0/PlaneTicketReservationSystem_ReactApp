    ...
    return (
        <>
            <Grid container spacing={1} alignItems='center'>
                            ...
                            <Grid item key={key}>
                                <Autocomplete
                                    ...
                                    onInputChange={(event, newInputValue) => {
                                        setSelectedValues([ ...selectedValues.slice(0, key), newInputValue, ...selectedValues.slice(key + 1)]);
                                    }}
                ...
                <Button variant="contained" color="primary" className={classes.searchButton} onClick={searchClickHandle}>
                    Search
                </Button>
            </Grid>
        </>
